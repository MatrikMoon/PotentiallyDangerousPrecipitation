...
export namespace proto.packet {
    ...
    export namespace Command {
        export class DoActionCommand extends pb_1.Message {
            #one_of_decls: number[][] = [];
            constructor(data?: any[] | {
                action?: dependency_1.proto.models.Action;
            }) {
                super();
                pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
                if (!Array.isArray(data) && typeof data == "object") {
            ...
            get action() {
                return pb_1.Message.getWrapperField(this, dependency_1.proto.models.Action, 1) as dependency_1.proto.models.Action;
            }
            set action(value: dependency_1.proto.models.Action) {
            ...
            static fromObject(data: {
                action?: ReturnType<typeof dependency_1.proto.models.Action.prototype.toObject>;
            }): DoActionCommand {
                const message = new DoActionCommand({});
                if (data.action != null) {
                    message.action = dependency_1.proto.models.Action.fromObject(data.action);
                }
                return message;
            }
            toObject() {
            ...
            static deserialize(bytes: Uint8Array | pb_1.BinaryReader): DoActionCommand {
                ...
                while (reader.nextField()) {
                    ...
                    switch (reader.getFieldNumber()) {
                        case 1:
                            reader.readMessage(message.action, () => message.action = dependency_1.proto.models.Action.deserialize(reader));
                            break;
                        default: reader.skipField();
                    }
                }
    ...
    export namespace Event {
        ...
        export class ArtifactAddedEvent extends pb_1.Message {
            #one_of_decls: number[][] = [];
            constructor(data?: any[] | {
                artifact?: dependency_1.proto.models.Toggle;
            }) {
                super();
                pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
                if (!Array.isArray(data) && typeof data == "object") {
            ...
            set artifact(value: dependency_1.proto.models.Toggle) {
                pb_1.Message.setWrapperField(this, 1, value);
            }
            get has_artifact() {
                return pb_1.Message.getField(this, 1) != null;
            ...
            static fromObject(data: {
                artifact?: ReturnType<typeof dependency_1.proto.models.Toggle.prototype.toObject>;
            }): ArtifactAddedEvent {
                const message = new ArtifactAddedEvent({});
                if (data.artifact != null) {
                    message.artifact = dependency_1.proto.models.Toggle.fromObject(data.artifact);
                }
                return message;
            }
            toObject() {
            ...
            static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ArtifactAddedEvent {
                ...
                while (reader.nextField()) {
                    ...
                    switch (reader.getFieldNumber()) {
                        case 1:
                            reader.readMessage(message.artifact, () => message.artifact = dependency_1.proto.models.Toggle.deserialize(reader));
                            break;
                        default: reader.skipField();
                    }
                }
